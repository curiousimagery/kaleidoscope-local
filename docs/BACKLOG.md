...
- ▶ **Spit-and-polish UI refinement** (Daniel's stated next phase now that the structural + review work is done) — interaction-feel tuning across the stepped flow, the thumbnail timeline, seam drag, and split reference.
