...
- **🖥️📱 Motion 16:9 enters with no aspect flash (B409).** Enter motion with a non-16:9 source → the preview should appear already at 16:9, with no brief 1:1/source-aspect frame before it. If you see a blank blink instead of a clean appearance, say so (we'd layer in a skeleton box).
