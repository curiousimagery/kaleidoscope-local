...
export const ICONS = {
  ...
  // per-control lock padlock (M3 guardrails) — the FIRST glyph shared across chromes (used
  // on the desktop slice controls today); shell/locks.js sources LOCK_ICON from these.
  ...
  lockOpen: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="5" y="11" width="14" height="9" rx="2"/><path d="M8 11V7a4 4 0 0 1 7.5-1.3"/></svg>`,
  ...
  // stop — ends a video RECORDING (record video mode); the record/pause toggle
  // below stays the live-capture freeze pattern. Filled to pair with the dot.
